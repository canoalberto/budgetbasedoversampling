...
public class ImbalancedOversampling extends AbstractClassifier implements MultiClassClassifier, CapabilitiesHandler {
...
//        	System.out.println("Instance type is safe");
    ...
    private void oversampleandtrain(Instance instance, Instances neighbors, double imbalanceRatio, double kappa) {
        ...
        int k = (int) Math.ceil(this.maxInstancesOption.getValue()*(1-imbalanceRatio));
